  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        />
        {showAddFriend && <FormdAddFriend onAddFriedn={handleAddFriend} />}
...
function FriendList({ friends, onSelection, selectedFriend }) {
  // const friends = initialFriends; => lifting up STATE
...
function FormdAddFriend({ onAddFriedn }) {
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  const [whoIsPaing, setWhoIsPaing] = useState("");
